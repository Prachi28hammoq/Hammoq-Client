...
const Reports = (props) => {
    ...
    return (
        <>
            ...
            {props.selectedWebsite == 'Poshmark' ?
                (<table class="table table-hover">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
                        ...
                        {props.orders.map((order, index) => {
                            return (
                                <tr>
                                    ...
                                    <td>{Math.round((parseFloat(order.itemPrice - order.earnings) + Number.EPSILON) * 100) / 100}</td>
                                    <td>{order.earnings}</td>
                                </tr>)
                        })}
                    </tbody>
                </table>) : null}
                {props.selectedWebsite == 'Mercari' ?
                (<table class="table table-hover">
                    <thead>
                        <tr>
                            <th scope="col">#</th>
